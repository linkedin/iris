...
Please do not file reports on Github for security issues, and instead email
security@linkedin.com preferably with the title "Github linkedin/iris - (short summary)".
